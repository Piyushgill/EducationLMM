                  ...
                  children: [
                    ...
                    _sectionTitle(
                      ...
                      onViewAll: _adminTestimonials.length > 3
                        ...
                        context,
                        MaterialPageRoute(
                          builder: (_) => _AllTestimonialsScreen(testimonials: _adminTestimonials),
                        ),
                      )
                          : null,
                    ),
      ...
      if (onViewAll != null)
        GestureDetector(
          ...
          child: Row(
            ...
            children: const [
              Text("View All", style: TextStyle(color: Color(0xff7C3AED), fontSize: 13, fontWeight: FontWeight.w600)),
              SizedBox(width: 2),
